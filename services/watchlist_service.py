...
def add_to_watchlist(user_id, film_id):
    ...
    if WatchlistEntry.query.filter_by(user_id=user_id, film_id=film_id).first() is not None:
        raise AlreadyInWatchlistError(f"Film '{film_id}' is already in the watchlist")
